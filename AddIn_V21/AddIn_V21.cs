...
namespace AddIn_V21
{
    public class AddIn_V21 : ContextMenuAddIn
    {
        ...
        public AddIn_V21(TiaPortal tiaPortal) : base("TiaAddIn-Spin")
        {
            ...
            var plcBlockHandler = new GenericImportExportHandler<PlcBlock, PlcBlockGroup>(
                ...
                importData =>
                {
                    try
                    {
                        ...
                        var importOptions = ImportOptions.Override | ImportOptions.ActivateInactiveCultures;
                        var swImportOptions = SWImportOptions.IgnoreMissingReferencedObjects | SWImportOptions.IgnoreStructuralChanges | SWImportOptions.IgnoreUnitAttributes;
#else

                        var importOptions = ImportOptions.Override;
                        var swImportOptions = SWImportOptions.IgnoreMissingReferencedObjects | SWImportOptions.IgnoreStructuralChanges | SWImportOptions.IgnoreUnitAttributes;
#endif

                        importData.group.Blocks.Import(importData.fileInfo, importOptions, swImportOptions);
                        return true;
                    }
                    catch (Exception ex)
                    {
            ...
            var plcTagTableHandler = new GenericImportExportHandler<PlcTagTable, PlcTagTableGroup>(
                ...
                importData =>
                {
                    try
                    {
                        ...
                        importData.group.TagTables.Import(importData.fileInfo, importOptions);
                        return true;
                    }
                    catch (Exception ex)
                    {
            ...
            var plcUDTHandler = new GenericImportExportHandler<PlcType, PlcTypeGroup>(
                ...
                importData =>
                {
                    try
                    {
                        ...
                        importData.group.Types.Import(importData.fileInfo, importOptions, swImportOptions);
                        return true;
                    }
                    catch (Exception ex)
                    {
            ...
            var plcWatchtableHandler = new GenericImportExportHandler<PlcWatchTable, PlcWatchAndForceTableGroup>(
                ...
                importData =>
                {
                    try
                    {
                        ...
                        importData.group.WatchTables.Import(importData.fileInfo, importOptions);
                        return true;
                    }
                    catch (Exception ex)
                    {
            ...
            var hmiScreenHandler = new GenericImportExportHandler<Screen, ScreenFolder>(
                ...
                importPredicate: importData =>
                {
                    try
                    {
                        ...
                        importData.group.Screens.Import(importData.fileInfo, importOptions);
                        return true;
                    }
                    catch (Exception ex)
                    {
