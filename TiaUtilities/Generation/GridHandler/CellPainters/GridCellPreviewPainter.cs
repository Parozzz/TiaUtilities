...
{
    public class GridCellPreviewPainter<T>(GenPlaceholderHandler placeholderHandler, GridDataPreviewer<T> previewer, GridDataSource<T> dataSource, GridSettings settings) where T : GridData
    {
        ...
        public PaintData? ShouldCellContentPaint(DataGridViewCellPaintingEventArgs args)
        {
            try
            {
        ...
        public void CellContentPaint(DataGridViewCellPaintingEventArgs args, PaintData paintData)
        {
        ...
        public bool PaintContent(DataGridViewCellPaintingEventArgs args, bool backgroundPainter)
        {
            ...
            var previewData = previewer.RequestPreview(columnIndex, gridData);
            if (previewData == null)
            {
                return false;
            }
