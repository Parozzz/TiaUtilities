...
namespace TiaUtilities.Generation.SettingsNew
{
    ...
    public record SettingsValueBinding(string PropertyName, string Name, string Description, SettingsEditorTypeEnum EditorType, SettingsSectionBinding Section, SettingsGroupBinding? Group);
    ...
    public class SettingsBindings
    {
        ...
        public SettingsBindings AddValue(string propertyName, string name, string description, SettingsEditorTypeEnum editorType)
        {
            ...
            SettingsValueBinding valueBinding = new(propertyName, name, description, editorType, section, lastGroup);
