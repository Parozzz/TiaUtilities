...
namespace SpinAddin.Utility
{
    public class Block
    {
        ...
        {
            var dir = Directory.CreateDirectory(AddIn.TEMP_PATH);
            ...
            if (ExportUtil.Export(_block.Export, filePath) != true)
            {
                _state = ExitState.CouldNotExport;
                return;
            }

            ExportUtil.Export(_block.Export, "C:\\Users\\User\\Desktop\\TestXMLFile.xml");
