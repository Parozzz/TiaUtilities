...
{
    public class AlarmGenerationData
    {
        ...
        public AlarmGenerationData(string consumerAddress, string coil1Address, string coil2Address, string description, bool enable)
        {
